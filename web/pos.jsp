<%-- Document : pos Created on : May 31, 2017, 10:04:58 PM Author : lexo --%>
                        ...
                        <%@include file='templates/header_pos.html' %>
                            ...
                            %>
                                            ...
                                            <div class="panel-body">
                                                <table class="table table-striped table-bordered" id="productsTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ResultSet productos=Conn1.listado(); while(productos.next()){ %>
                                                            <tr onclick="addItem(<%= productos.getString(1) %>,<%= productos.getString(2) %>,'<%= productos.getString(3) %>',<%= productos.getString(7) %>,<%= productos.getString(4) %>,<%= productos.getString(5) %>)">
                                                                <th scope="row">
                                        ...
                                        <div class="panel panel-success" style=" min-height: 40em; ">
                                            ...
                                            <div class="panel-body">
                                                <form action="crearVenta" method="post" id="posForm">
                                                    ...
                                                    <div class="col col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <select name='cliente' id="cliente" class='form-control selectpicker' data-live-search="true">
                                                                ...
                                                                ResultSet clientes=conn2.listado(); while(clientes.next()){ %>
                                                    ...
                                                    <div class="col col-md-12" style="min-height: 25em;">
                                ...
                                <script>
                                    ...
                                    function addItem(id, codigo, nombre, stock, precio, compra) {
                                        //bootbox.prompt("Cantidad de elementos a vender", function(result) {
                                        bootbox.prompt({
                                            title: "Cantidad de elementos a vender",
                                            inputType: 'number',
                                            value: 1,
                                            ...
                                            var cantidad = result;
                                            if(result != null){
                                            console.log('Producto: ' + nombre + " ID:" + id + " Codigo: " + codigo + " stock: " + stock+" cantidad: "+result);
                                            $('#venta_tabla tr:last').after('<tr onclick ="delete_item($(this))">' +
                                                '<input type="hidden" name="id[]" value="' + id + '">' +
                                                '<input type="hidden" name="codigo[]" value="' + codigo + '">' +
                                                '<input type="hidden" name="cantidad[]" value="' + cantidad + '">' +
                                                '<input type="hidden" name="precio_compra[]" value="' + compra + '">' +
                                                '<input type="hidden" name="precio_venta[]" value="' + precio + '">' +
                                                '<td>' + codigo + '</td>' +
                                                '<td>' + nombre + '</td>' +
                                                '<td>' + cantidad + '</td>' +
                                                '<td>' + precio + '</td>' +
